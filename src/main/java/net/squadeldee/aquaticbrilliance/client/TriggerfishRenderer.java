...
public class TriggerfishRenderer extends GeoEntityRenderer<TriggerfishEntity> {
    public TriggerfishRenderer(EntityRendererProvider.Context renderManager) {
        super(renderManager, new TriggerfishModel());
        this.shadowRadius = 0.3f;
    }

    @Override
    public ResourceLocation getTextureLocation(TriggerfishEntity instance) {
    ...
    @Override
    public RenderType getRenderType(TriggerfishEntity animatable, float partialTicks, PoseStack stack,
    ...
    @Override
    protected void applyRotations(TriggerfishEntity endWhale, PoseStack matrixStackIn, float ageInTicks, float rotationYaw, float partialTicks) {
