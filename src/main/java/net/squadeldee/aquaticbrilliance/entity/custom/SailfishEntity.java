...
public class SailfishEntity extends WaterAnimal implements IAnimatable, Bucketable {
    private static final EntityDataAccessor<Boolean> FROM_BUCKET = SynchedEntityData.defineId(SailfishEntity.class, EntityDataSerializers.BOOLEAN);
    ...
    private static final EntityDataAccessor<Integer> ATTACK_TICK = SynchedEntityData.defineId(SailfishEntity.class, EntityDataSerializers.INT);
...
//        }
    ...
    private static final EntityDataAccessor<Integer> PASSIVE = SynchedEntityData.defineId(SailfishEntity.class, EntityDataSerializers.INT);
    ...
    public SailfishEntity(EntityType<? extends WaterAnimal> entityType, Level level) {
        super(entityType, level);
        this.setPathfindingMalus(BlockPathTypes.WATER, 0.0F);
        this.lookControl = new SmoothSwimmingLookControl(this, 10);
        this.moveControl = new SailfishEntity.MoveHelperController(this);
    }
...
//        this.goalSelector.addGoal(2, new SailfishEntity.SwimWithPlayerGoal(this, 4.0D));
//        this.targetSelector.addGoal(3, new NearestAttackableTargetGoal<>(this, Squid.class, true && this.getHuntDelay() <= 0));
    ...
    static class SwimWithPlayerGoal extends Goal {
        private final SailfishEntity dolphin;
        private final double speed;
        private Player targetPlayer;

        SwimWithPlayerGoal(SailfishEntity dolphinIn, double speedIn) {
        ...
        public boolean canUse() {
            this.targetPlayer = this.dolphin.level.getNearestPlayer(SailfishEntity.PLAYER_PREDICATE, this.dolphin);
    ...
    public <E extends IAnimatable> PlayState predicate(AnimationEvent<E> event) {
        ...
        if (this.getAttackTick() > 0){
            event.getController().setAnimation(new AnimationBuilder().addAnimation("slash", ILoopType.EDefaultLoopTypes.LOOP));
            return PlayState.CONTINUE;
        }
...
//    }
    ...
    static class MoveHelperController extends MoveControl {
        ...
        public MoveHelperController(SailfishEntity dolphinIn) {
            super(dolphinIn);
            this.dolphin = dolphinIn;
        }
        ...
        public void tick() {
            ...
            if (this.operation == MoveControl.Operation.MOVE_TO && !this.dolphin.getNavigation().isDone()) {
                ...
                if (d3 < (double) 2.5000003E-7F) {
                    ...
                    float f1 = (float) (this.speedModifier * this.dolphin.getAttributeValue(Attributes.MOVEMENT_SPEED) * 1.5F);
                    if (this.dolphin.isInWater()) {
